...
extension SpanAttributes {
    ...
    public struct AppAttributes: SpanAttributeNamespace {
        ...
        public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
            ...
            public var buildId: SpanAttributeKey<String> { .init(name: OTelAttribute.app.buildId) }
        }

        /// `app.crash` namespace
        public var crash: CrashAttributes {
            get {
        ...
        @dynamicMemberLookup
        public struct CrashAttributes: SpanAttributeNamespace {
            public var attributes: Tracing.SpanAttributes
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: SpanAttributeKey<String> { .init(name: OTelAttribute.app.crash.id) }
            }
        }

        /// `app.installation` namespace
        public var installation: InstallationAttributes {
            get {
                .init(attributes: self.attributes)
            }
            set {
        ...
        @dynamicMemberLookup
        public struct InstallationAttributes: SpanAttributeNamespace {
            public var attributes: Tracing.SpanAttributes
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                public var id: SpanAttributeKey<String> { .init(name: OTelAttribute.app.installation.id) }
            }
        }

        /// `app.jank` namespace
        public var jank: JankAttributes {
            get {
                .init(attributes: self.attributes)
            }
            set {
        ...
        @dynamicMemberLookup
        public struct JankAttributes: SpanAttributeNamespace {
            public var attributes: Tracing.SpanAttributes
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///     - `0.700`
                ///     - `1.024`
                public var threshold: SpanAttributeKey<Double> { .init(name: OTelAttribute.app.jank.threshold) }
            }
        }

        /// `app.screen` namespace
        public var screen: ScreenAttributes {
            get {
                .init(attributes: self.attributes)
            }
            set {
        ...
        @dynamicMemberLookup
        public struct ScreenAttributes: SpanAttributeNamespace {
            public var attributes: Tracing.SpanAttributes
            ...
            public var coordinate: CoordinateAttributes {
                get {
                    .init(attributes: self.attributes)
                }
                set {
            ...
            @dynamicMemberLookup
            public struct CoordinateAttributes: SpanAttributeNamespace {
                public var attributes: Tracing.SpanAttributes
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    ///     - `12`
                    ///     - `99`
                    public var y: SpanAttributeKey<Int> { .init(name: OTelAttribute.app.screen.coordinate.y) }
                }
            }
        }

        /// `app.widget` namespace
        public var widget: WidgetAttributes {
            get {
                .init(attributes: self.attributes)
            }
            set {
        ...
        @dynamicMemberLookup
        public struct WidgetAttributes: SpanAttributeNamespace {
            public var attributes: Tracing.SpanAttributes
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                ///
                /// A widget is an application component, typically an on-screen visual GUI element.
                public var name: SpanAttributeKey<String> { .init(name: OTelAttribute.app.widget.name) }
            }
        }
    }
    #endif
