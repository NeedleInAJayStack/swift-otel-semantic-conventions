    ...
    public struct VcsAttributes: SpanAttributeNamespace {
        ...
        public struct ChangeAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// `vcs.change.id` **UNSTABLE**: The ID of the change (pull request/merge request/changelist) if applicable. This is usually a unique (within repository) identifier generated by the VCS system.
                ///
                ...
                /// `vcs.change.state` **UNSTABLE**: The state of the change (pull request/merge request/changelist).
                ///
                /// - Stability: releaseCandidate
                /// - Type: enum
                ...
                /// `vcs.change.title` **UNSTABLE**: The human readable title of the change (pull request/merge request/changelist). This title is often a brief summary of the change and may get merged in to a ref as the commit summary.
                ///
                /// - Stability: releaseCandidate
                /// - Type: string
                /// - Examples:
        ...
        public struct LineChangeAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// `vcs.line_change.type` **UNSTABLE**: The type of line change being measured on a branch or change.
                ///
                /// - Stability: releaseCandidate
                /// - Type: enum
        ...
        public struct OwnerAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// `vcs.owner.name` **UNSTABLE**: The group owner within the version control system.
                ///
                /// - Stability: releaseCandidate
                /// - Type: string
                /// - Examples:
        ...
        public struct ProviderAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// `vcs.provider.name` **UNSTABLE**: The name of the version control system provider.
                ///
                /// - Stability: releaseCandidate
                /// - Type: enum
        ...
        public struct RefAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// `vcs.ref.type` **UNSTABLE**: The type of the [reference](https://git-scm.com/docs/gitglossary#def_ref) in the repository.
                ///
                /// - Stability: releaseCandidate
                /// - Type: enum
            ...
            public struct BaseAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// `vcs.ref.base.name` **UNSTABLE**: The name of the [reference](https://git-scm.com/docs/gitglossary#def_ref) such as **branch** or **tag** in the repository.
                    ///
                    /// - Stability: releaseCandidate
                    /// - Type: string
                    /// - Examples:
                    ...
                    /// `vcs.ref.base.revision` **UNSTABLE**: The revision, literally [revised version](https://www.merriam-webster.com/dictionary/revision), The revision most often refers to a commit object in Git, or a revision number in SVN.
                    ///
                    /// - Stability: releaseCandidate
                    /// - Type: string
                    /// - Examples:
                    ...
                    /// `vcs.ref.base.type` **UNSTABLE**: The type of the [reference](https://git-scm.com/docs/gitglossary#def_ref) in the repository.
                    ///
                    /// - Stability: releaseCandidate
                    /// - Type: enum
                    ///     - `branch`: [branch](https://git-scm.com/docs/gitglossary#Documentation/gitglossary.txt-aiddefbranchabranch)
            ...
            public struct HeadAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// `vcs.ref.head.name` **UNSTABLE**: The name of the [reference](https://git-scm.com/docs/gitglossary#def_ref) such as **branch** or **tag** in the repository.
                    ///
                    /// - Stability: releaseCandidate
                    /// - Type: string
                    /// - Examples:
                    ...
                    /// `vcs.ref.head.revision` **UNSTABLE**: The revision, literally [revised version](https://www.merriam-webster.com/dictionary/revision), The revision most often refers to a commit object in Git, or a revision number in SVN.
                    ///
                    /// - Stability: releaseCandidate
                    /// - Type: string
                    /// - Examples:
                    ...
                    /// `vcs.ref.head.type` **UNSTABLE**: The type of the [reference](https://git-scm.com/docs/gitglossary#def_ref) in the repository.
                    ///
                    /// - Stability: releaseCandidate
                    /// - Type: enum
                    ///     - `branch`: [branch](https://git-scm.com/docs/gitglossary#Documentation/gitglossary.txt-aiddefbranchabranch)
        ...
        public struct RepositoryAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// `vcs.repository.name` **UNSTABLE**: The human readable name of the repository. It SHOULD NOT include any additional identifier like Group/SubGroup in GitLab or organization in GitHub.
                ///
                /// - Stability: releaseCandidate
                /// - Type: string
                /// - Examples:
            ...
            public struct ChangeAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// `vcs.repository.change.id` **UNSTABLE**: Deprecated, use `vcs.change.id` instead.
                    ///
                    ...
                    /// `vcs.repository.change.title` **UNSTABLE**: Deprecated, use `vcs.change.title` instead.
                    ///
                    /// - Stability: development
                    /// - Type: string
                    /// - Examples:
            ...
            public struct RefAttributes: SpanAttributeNamespace {
                ...
                public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                    ...
                    /// `vcs.repository.ref.name` **UNSTABLE**: Deprecated, use `vcs.ref.head.name` instead.
                    ///
                    /// - Stability: development
                    /// - Type: string
                    /// - Examples:
                    ...
                    /// `vcs.repository.ref.revision` **UNSTABLE**: Deprecated, use `vcs.ref.head.revision` instead.
                    ///
                    /// - Stability: development
                    /// - Type: string
                    /// - Examples:
                    ...
                    /// `vcs.repository.ref.type` **UNSTABLE**: Deprecated, use `vcs.ref.head.type` instead.
                    ///
                    /// - Stability: development
                    /// - Type: enum
                    ///     - `branch`: [branch](https://git-scm.com/docs/gitglossary#Documentation/gitglossary.txt-aiddefbranchabranch)
        ...
        public struct RevisionDeltaAttributes: SpanAttributeNamespace {
            ...
            public struct NestedSpanAttributes: NestedSpanAttributesProtocol {
                ...
                /// `vcs.revision_delta.direction` **UNSTABLE**: The type of revision comparison.
                ///
                /// - Stability: releaseCandidate
                /// - Type: enum
